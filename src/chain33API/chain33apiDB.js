...
//slideIn 1 (代扣)
export async function SLIDEINONE(
  addr,
  amount,
  payKey,
  privkey,
...
//slideIn 2 (代扣)
export async function SLIDEINTWO(
  amount,
  payKey,
  privkey,
  isToken,
...
//slideout 2（代扣）
export async function SLIDEOUTTWO(
  myAddr,
  amount,
  payKey,
  privkey,
...
//slideout 3 (代扣)
export async function SLIDEOUTTHREE(
  addr,
  amount,
  payforKey,
  localKey,
...
//transfer(代扣)
export async function TRANSFERUWALLET(
  myAddr,
  toAddr,
  localKey,
  payKey,
